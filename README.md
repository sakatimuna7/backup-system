...
[![Version](https://img.shields.io/badge/version-0.10.0-blue.svg)](https://github.com/sakatimuna7/backup-system/releases/tag/v0.10.0)
...
```sh
# Install
curl -LO https://github.com/sakatimuna7/backup-system/releases/download/v0.10.0/backup-system-linux-amd64
curl -LO https://github.com/sakatimuna7/backup-system/releases/download/v0.10.0/SHA256SUMS
